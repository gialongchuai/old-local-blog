    ...
    <>
      ...
      >
        ...
        <div className="w-full">
          ...
          <div className="h-2 bg-neutral-quaternary rounded-full max-w-[480px] mb-2.5" />
          <div className="h-2 bg-neutral-quaternary rounded-full mb-2.5" />
          <div className="h-2 bg-neutral-quaternary rounded-full max-w-[440px] mb-2.5" />
          <div className="h-2 bg-neutral-quaternary rounded-full max-w-[460px] mb-2.5" />
