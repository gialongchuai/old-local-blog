    ...
    <>
      <div className="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
        ...
        <div className="flex flex-col gap-2 p-4 lg:p-6">
          ...
          <p className="text-gray-500">
            Nghịch cảnh là một phần của cuộc sống. Nó không thể bị kiểm soát.
            Cái có thể kiểm soát chính là cách chúng ta phản ứng trước nghịch
            cảnh.
          </p>
          <div>
      ...
      <div className="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
        ...
        <div className="flex flex-col gap-2 p-4 lg:p-6">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            Muốn thành công thì khao khát thành công phải lớn hơn nỗi sợ bị thất
            bại.
          </h2>
          <p className="text-gray-500">
      ...
      <div className="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
        ...
        <div className="flex flex-col gap-2 p-4 lg:p-6">
          ...
          <h2 className="text-xl font-bold text-gray-800">
            Mất niềm tin vào bản thân, cũng như bạn đánh mất thành công đang đợi
            mình
          </h2>
          <p className="text-gray-500">
            Ai cũng nói tương lai chúng ta luôn rộng mở, nhưng nếu không nắm bắt
            được hiện tại thì tương lai sẽ chẳng có gì.
          </p>
          <div>
            <div className="inline-flex rounded-md shadow-sm" role="group">
              <button
      ...
      <div className="flex flex-col items-center overflow-hidden rounded-lg border md:flex-row">
        ...
        <div className="flex flex-col gap-2 p-4 lg:p-6">
          ...
          <p className="text-gray-500">
            Tôi có thể chấp nhận thất bại, mọi người đều thất bại ở một việc gì
            đó. Nhưng tôi không chấp nhận việc không cố gắng.
          </p>
          <div>
            <div className="inline-flex rounded-md shadow-sm" role="group">
              <button
